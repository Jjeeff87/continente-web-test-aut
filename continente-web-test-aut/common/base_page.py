...
class BasePage:
    ...
    Concentrates the common operations (waiting for an element, clicking,
    humanized typing) to reduce duplication between the Page Objects of each
    site (Shein, Continente, IKEA, ...). Each specific Page Object inherits
    from this class and only defines its own locators and flows.
    """
